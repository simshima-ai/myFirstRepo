export function createDomRefs() {
  ...
  selectToolDxInput: document.getElementById("selectToolDxInput"),
  selectToolDyInput: document.getElementById("selectToolDyInput"),
  selectToolMoveBtn: document.getElementById("selectToolMoveBtn"),
  selectToolCopyBtn: document.getElementById("selectToolCopyBtn"),
  ...
  selectionLeaderStyleEdit: document.getElementById("selectionLeaderStyleEdit"),
  selectionLeaderArrowTypeSelect: document.getElementById("selectionLeaderArrowTypeSelect"),
  selectionLeaderArrowSizeInput: document.getElementById("selectionLeaderArrowSizeInput"),
  selectionLeaderLineWidthInput: document.getElementById("selectionLeaderLineWidthInput"),
  selectionLeaderColorInput: document.getElementById("selectionLeaderColorInput"),
  ...
  moveToolDxInput: document.getElementById("moveToolDxInput"),
  moveToolDyInput: document.getElementById("moveToolDyInput"),
  moveToolApplyBtn: document.getElementById("moveToolApplyBtn"),
  moveToolCopyBtn: document.getElementById("moveToolCopyBtn"),
  ...
  rectAsPolylineToggle: document.getElementById("rectAsPolylineToggle"),
  ...
  dimNumericPriorityToggle: document.getElementById("dimNumericPriorityToggle"),
  dimNumericValueInput: document.getElementById("dimNumericValueInput"),
  ...
  dimLabelTextInput: document.getElementById("dimLabelTextInput"),
  applyDimPrecisionBtn: document.getElementById("applyDimPrecisionBtn"),
  dimNumericValueWrap: document.getElementById("dimNumericValueWrap"),
  dimChainNumericValuesWrap: document.getElementById("dimChainNumericValuesWrap"),
  dimChainNumericValuesList: document.getElementById("dimChainNumericValuesList"),
  ...
  wheelZoomFactorSelect: document.getElementById("wheelZoomFactorSelect"),
  uiLanguageSelect: document.getElementById("uiLanguageSelect"),
  menuScaleModeSelect: document.getElementById("menuScaleModeSelect"),
  menuScaleAutoSelect: document.getElementById("menuScaleAutoSelect"),
  ...
  projectFolderLabel: document.getElementById("projectFolderLabel"),
  selectProjectFolderBtn: document.getElementById("selectProjectFolderBtn"),
  clearProjectFolderBtn: document.getElementById("clearProjectFolderBtn"),
  ...
  settingsBuildBadge: document.getElementById("settingsBuildBadge"),
  selectionDebugBadge: document.getElementById("selectionDebugBadge"),
  ...
  viewerEmptyStateTitle: document.getElementById("viewerEmptyStateTitle"),
  viewerEmptyStateText: document.getElementById("viewerEmptyStateText"),
  statusText: document.getElementById("statusText"),
  viewerImportMeta: document.getElementById("viewerImportMeta"),
  viewerImportUnitLabel: document.getElementById("viewerImportUnitLabel"),
  viewerImportUnitValue: document.getElementById("viewerImportUnitValue"),
  viewerImportBoundsLabel: document.getElementById("viewerImportBoundsLabel"),
  viewerImportBoundsValue: document.getElementById("viewerImportBoundsValue"),
  viewerImportScaleBtn1: document.getElementById("viewerImportScaleBtn1"),
  viewerImportScaleBtn2: document.getElementById("viewerImportScaleBtn2"),
  viewerImportScaleBtn3: document.getElementById("viewerImportScaleBtn3"),
  viewerImportResetViewBtn: document.getElementById("viewerImportResetViewBtn"),
  startSetupOverlay: document.getElementById("startSetupOverlay"),
  startSetupTitle: document.getElementById("startSetupTitle"),
  startSetupSubtitle: document.getElementById("startSetupSubtitle"),
  startSetupProjectFolderLabel: document.getElementById("startSetupProjectFolderLabel"),
  startSetupSelectProjectFolderBtn: document.getElementById("startSetupSelectProjectFolderBtn"),
  startSetupClearProjectFolderBtn: document.getElementById("startSetupClearProjectFolderBtn"),
  startSetupProjectFolderStatus: document.getElementById("startSetupProjectFolderStatus"),
  startSetupPageTitle: document.getElementById("startSetupPageTitle"),
  startSetupPageSizeLabel: document.getElementById("startSetupPageSizeLabel"),
  startSetupPageSizeSelect: document.getElementById("startSetupPageSizeSelect"),
  startSetupOrientationLabel: document.getElementById("startSetupOrientationLabel"),
  startSetupOrientationSelect: document.getElementById("startSetupOrientationSelect"),
  startSetupCustomPageToggle: document.getElementById("startSetupCustomPageToggle"),
  startSetupCustomPageToggleLabel: document.getElementById("startSetupCustomPageToggleLabel"),
  startSetupCustomPageWidthInput: document.getElementById("startSetupCustomPageWidthInput"),
  startSetupCustomPageHeightInput: document.getElementById("startSetupCustomPageHeightInput"),
  startSetupCustomPageWidthUnitLabel: document.getElementById("startSetupCustomPageWidthUnitLabel"),
  startSetupCustomPageHeightUnitLabel: document.getElementById("startSetupCustomPageHeightUnitLabel"),
  startSetupWidthLabel: document.getElementById("startSetupWidthLabel"),
  startSetupHeightLabel: document.getElementById("startSetupHeightLabel"),
  startSetupScaleLabel: document.getElementById("startSetupScaleLabel"),
  startSetupPageScaleSelect: document.getElementById("startSetupPageScaleSelect"),
  startSetupCustomScaleToggle: document.getElementById("startSetupCustomScaleToggle"),
  startSetupCustomScaleToggleLabel: document.getElementById("startSetupCustomScaleToggleLabel"),
  startSetupCustomScaleInput: document.getElementById("startSetupCustomScaleInput"),
  startSetupUnitLabel: document.getElementById("startSetupUnitLabel"),
  startSetupPageUnitSelect: document.getElementById("startSetupPageUnitSelect"),
  startSetupMarginLabel: document.getElementById("startSetupMarginLabel"),
  startSetupPageInnerMarginInput: document.getElementById("startSetupPageInnerMarginInput"),
  startSetupPageInnerMarginUnitLabel: document.getElementById("startSetupPageInnerMarginUnitLabel"),
  startSetupPageShowFrameToggle: document.getElementById("startSetupPageShowFrameToggle"),
  startSetupPageShowFrameLabel: document.getElementById("startSetupPageShowFrameLabel"),
  startSetupGridTitle: document.getElementById("startSetupGridTitle"),
  startSetupGridSizeLabel: document.getElementById("startSetupGridSizeLabel"),
  startSetupGridSizeSelect: document.getElementById("startSetupGridSizeSelect"),
  startSetupGridUnitLabel: document.getElementById("startSetupGridUnitLabel"),
  startSetupCustomGridToggle: document.getElementById("startSetupCustomGridToggle"),
  startSetupCustomGridToggleLabel: document.getElementById("startSetupCustomGridToggleLabel"),
  startSetupCustomGridInput: document.getElementById("startSetupCustomGridInput"),
  startSetupCustomGridUnitLabel: document.getElementById("startSetupCustomGridUnitLabel"),
  startSetupGridShowToggle: document.getElementById("startSetupGridShowToggle"),
  startSetupGridShowLabel: document.getElementById("startSetupGridShowLabel"),
  startSetupGridAutoToggle: document.getElementById("startSetupGridAutoToggle"),
  startSetupGridAutoLabel: document.getElementById("startSetupGridAutoLabel"),
  startSetupGridAutoTimingTitle: document.getElementById("startSetupGridAutoTimingTitle"),
  startSetupGridAutoTimingSlider: document.getElementById("startSetupGridAutoTimingSlider"),
  startSetupGridAutoTimingLabel: document.getElementById("startSetupGridAutoTimingLabel"),
  startSetupGridAutoHint: document.getElementById("startSetupGridAutoHint"),
  startSetupStartBtn: document.getElementById("startSetupStartBtn"),
  touchConfirmOverlay: document.getElementById("touchConfirmOverlay"),
  touchLineFinishBtn: document.getElementById("touchLineFinishBtn"),
  touchToolPanel: document.getElementById("touchToolPanel"),
  touchToolPanelHeader: document.getElementById("touchToolPanelHeader"),
  touchToolPanelTitle: document.getElementById("touchToolPanelTitle"),
  touchToolPanelStatus: document.getElementById("touchToolPanelStatus"),
