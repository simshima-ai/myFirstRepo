const JA_PANEL_TEXT = {
  hiddenSuffix: " (\u975e\u8868\u793a)",
  selectionModeTitle: "\u9078\u629e\u30e2\u30fc\u30c9",
  vertexEditTitle: "\u9802\u70b9\u7de8\u96c6",
  lineTitle: "\u30e9\u30a4\u30f3",
  rectTitle: "\u77e9\u5f62",
  circleTitle: "\u5186",
  filletTitle: "\u30d5\u30a3\u30ec\u30c3\u30c8",
  trimTitle: "\u30c8\u30ea\u30e0",
  positionTitle: "\u4f4d\u7f6e\u30de\u30fc\u30ab\u30fc",
  textTitle: "\u30c6\u30ad\u30b9\u30c8",
  dimTitle: "\u5bf8\u6cd5\u8a2d\u5b9a",
  hatchTitle: "\u30cf\u30c3\u30c1\u30f3\u30b0",
  importAdjustTitle: "\u30a4\u30f3\u30dd\u30fc\u30c8\u8abf\u6574",
  traceTitle: "\u753b\u50cf\u30c8\u30ec\u30fc\u30b9(\u5b9f\u9a13)",
  patternCopyTitle: "\u30d1\u30bf\u30fc\u30f3\u30b3\u30d4\u30fc",
  doublelineTitle: "\u8907\u7dda",
  previewTitle: "\u30d7\u30ec\u30d3\u30e5\u30fc",
  settingsTitle: "\u8a2d\u5b9a",
  gridSettingsTitle: "\u30b0\u30ea\u30c3\u30c9\u8a2d\u5b9a",
  keyboardShortcutsLabel: "\u30ad\u30fc\u30dc\u30fc\u30c9\u30b7\u30e7\u30fc\u30c8\u30ab\u30c3\u30c8",
  keyboardShortcutsHint: "\u4e3b\u8981\u30c4\u30fc\u30eb\u3068\u524a\u9664\u306e\u30b7\u30e7\u30fc\u30c8\u30ab\u30c3\u30c8\u8a2d\u5b9a",
  selectionTextEditTitle: "\u9078\u629e\u4e2d\u306e\u30c6\u30ad\u30b9\u30c8\u7de8\u96c6",
  selectionLeaderStyleTitle: "\u30ea\u30fc\u30c0\u30fc\u30b9\u30bf\u30a4\u30eb",
  homeModeTitle: "\u30e2\u30fc\u30c9",
  touchPanelTitle: "\u30bf\u30c3\u30c1\u30e2\u30fc\u30c9\u30d1\u30cd\u30eb",
  snapTitle: "\u30b9\u30ca\u30c3\u30d7",
  attrsTitle: "\u5c5e\u6027",
  viewTitle: "\u8868\u793a",
  groupsTitle: "\u30b0\u30eb\u30fc\u30d7",
  layersTitle: "\u30ec\u30a4\u30e4\u30fc",
  pageSettingsTitle: "\u7528\u7d19\u8a2d\u5b9a",
  interfaceSectionTitle: "\u30a4\u30f3\u30bf\u30fc\u30d5\u30a7\u30fc\u30b9",
  debugConsoleTitle: "\u30c7\u30d0\u30c3\u30b0\u30b3\u30f3\u30bd\u30fc\u30eb",
  pngExportTitle: "PNG \u51fa\u529b",
...
const EN_PANEL_TEXT = {
  ...
  vertexEditTitle: "Vertex Edit",
  lineTitle: "Line",
  rectTitle: "Rectangle",
  circleTitle: "Circle",
  filletTitle: "Fillet",
  trimTitle: "Trim",
  positionTitle: "Position Marker",
  textTitle: "Text",
  dimTitle: "Dimension Settings",
  hatchTitle: "Hatching",
  importAdjustTitle: "Import Adjust",
  traceTitle: "Image Trace (Experimental)",
  patternCopyTitle: "Pattern Copy",
  doublelineTitle: "Double Line",
  previewTitle: "Preview",
  settingsTitle: "Settings",
  gridSettingsTitle: "Grid Settings",
  keyboardShortcutsLabel: "Keyboard Shortcuts",
  keyboardShortcutsHint: "Shortcut settings for major tools and delete",
  selectionTextEditTitle: "Edit Selected Text",
  selectionLeaderStyleTitle: "Leader Style",
  homeModeTitle: "Mode",
  touchPanelTitle: "Touch Mode",
  snapTitle: "Snap",
...
const STATUS_EXACT_JA = new Map([
  ...
  ["Viewer mode | Drag and drop a DXF or SVG file here", "\u30d3\u30e5\u30fc\u30ef\u30fc\u30e2\u30fc\u30c9 | \u3053\u3053\u306b DXF \u307e\u305f\u306f SVG \u3092\u30c9\u30e9\u30c3\u30b0\u30a2\u30f3\u30c9\u30c9\u30ed\u30c3\u30d7\u3057\u3066\u304f\u3060\u3055\u3044"],
]);
...
export function getStatusBarText(langLike) {
  ...
  if (lang === "ja") {
    return {
      ...
      bounds: "\u5916\u5f62\u30b5\u30a4\u30ba",
      resetView: "\u5168\u4f53\u8868\u793a",
      viewerEmptyTitle: "\u30c7\u30fc\u30bf\u304c\u3042\u308a\u307e\u305b\u3093",
      viewerEmpty: "\u30d3\u30e5\u30fc\u30ef\u30fc\u30e2\u30fc\u30c9 | \u3053\u3053\u306b DXF \u307e\u305f\u306f SVG \u3092\u30c9\u30e9\u30c3\u30b0\u30a2\u30f3\u30c9\u30c9\u30ed\u30c3\u30d7\u3057\u3066\u304f\u3060\u3055\u3044",
  ...
  return {
    ...
    viewerEmptyTitle: "No data loaded",
    viewerEmpty: "Viewer mode | Drag and drop a DXF or SVG file here",
...
export function getTouchConfirmText(langLike) {
  ...
  if (lang === "ja") {
    return {
      ...
      dimTarget: "ターゲットを確定",
      dimSecondTarget: "2つ目を確定",
      dimPlacement: "配置位置を確定",
      dimCreate: "寸法を作成",
      dimAngleCreate: "角度寸法を作成",
      dimLeaderCreate: "リーダー寸法を作成",
      dimChainAddTarget: "ターゲットを追加",
      dimChainConfirmTarget: "ターゲットを確定",
      dimChainGenerate: "寸法線を生成",
      circleCenterConfirm: "中心点を確定",
      circleEdgeConfirm: "円周点を確定",
      circleAddTarget: "ターゲットとして登録",
      circleCreateCircumscribed: "外接円を生成",
      applyFillet: "フィレット適用",
  ...
  return {
    ...
    dimTarget: "Confirm Target",
    dimSecondTarget: "Confirm 2nd Target",
    dimPlacement: "Confirm Placement",
    dimCreate: "Create Dimension",
    dimAngleCreate: "Create Angle Dimension",
    dimLeaderCreate: "Create Leader Dimension",
    dimChainAddTarget: "Add Target",
    dimChainConfirmTarget: "Confirm Target",
    dimChainGenerate: "Generate Dimension Line",
    circleCenterConfirm: "Confirm Center Point",
    circleEdgeConfirm: "Confirm Edge Point",
    circleAddTarget: "Add as Target",
    circleCreateCircumscribed: "Create Circumscribed Circle",
